  ...
  return (
    <div className="min-h-screen bg-gray-800 text-white">
      ...
      <main className="flex min-h-screen w-full flex-col gap-6 p-4 sm:p-10 md:flex-row">
        ...
        <div className="hidden border-l border-white md:block"></div>
        <div className="flex h-fit w-full flex-col gap-3 md:w-1/2">
          <h2 className="text-lg font-medium text-white">API</h2>
          <div className="mt-3 flex h-fit w-full flex-col rounded-xl bg-gray-700 bg-opacity-70 p-4">
            ...
            <div className="mt-4 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <div className="flex flex-wrap items-center gap-2">
                <span className="w-full max-w-[200px] overflow-x-auto rounded-md border border-gray-800 px-3 py-1 text-sm text-gray-400 sm:w-auto">
                  {quota.secretKey}
                </span>
